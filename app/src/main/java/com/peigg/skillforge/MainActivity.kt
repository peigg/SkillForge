...
import com.peigg.skillforge.bd.DbHelper
import com.peigg.skillforge.bd.SQL_CREATE_ENTRIES
import com.peigg.skillforge.bd.SkillForgeDatabase
       ...
       db.execSQL(
           """
              INSERT INTO ${SkillForgeDatabase.TABLE_NAME} (${SkillForgeDatabase.COLUMN_NAME}, ${SkillForgeDatabase.COLUMN_IMAGE}, ${SkillForgeDatabase.COLUMN_SPEC}, ${SkillForgeDatabase.COLUMN_DESCRIPTION}, ${SkillForgeDatabase.COLUMN_PRICE})
                VALUES ('Paco Ramirez', ${R.drawable.image_paco}, 'Desarrollo de aplicaciones móviles', 'Soy un desarrollador de aplicaciones móviles con 5 años de experiencia. He trabajado en proyectos de gran envergadura y me encantaría ayudarte a mejorar tus habilidades.', 'S/ 100')
           """.trimIndent()
       )*/
        setContent {
            SkillForgeTheme {
